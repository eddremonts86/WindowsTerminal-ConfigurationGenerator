  ...
  <v-container>
    ...
    <v-dialog v-model="dialog" max-width="500px">
      <v-card>
        ...
        <v-card-text>
          <small v-text="desc.desc" class="body-1"></small>
        </v-card-text>
    ...
    itemList: {
      Globals: [
...

        {
          ...
          values: [],
          desc:
            "Sets the width of the tabs. Possible values: <br>'equal': sizes each tab to the same width <br>'titleLength': sizes each tab to the length of its title <br>'compact': sizes each tab to the length of its title when focused, and shrinks to the size of only the icon when the tab is unfocused."
        },
        {
